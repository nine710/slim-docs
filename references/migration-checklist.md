...
- [ ] `python <path-to-this-skill>/scripts/measure_entry.py --root <project> --tier <tier>` exit 0
- [ ] `python <path-to-this-skill>/scripts/check_agent_docs.py --root <project> --tier <tier>` exit 0
